...
class test_thread extends Thread{
	public void run() {
		...
		String write_name = "ubuntu16-test.log";
		String topic = "ubuntu16-test";
		try{
			while(true){
...
class messages_thread extends Thread{
	public void run() {
		...
		String write_path = "/home/lsiem/logs/";
		String write_name = "ubuntu16-messages.log";
		String topic = "ubuntu16-messages";
		try{
			while(true){
				css.syslog(read_path,write_name,write_path,topic);
				Thread.sleep(10*1000);
...
class boot_thread extends Thread{
	public void run() {
		...
		String write_path = "/home/lsiem/logs/";
		String write_name = "ubuntu16-boot.log";
		String topic = "ubuntu16-boot";
		try{
			while(true){
				css.syslog(read_path,write_name,write_path,topic);
				Thread.sleep(10*1000);
...
class dmsg_thread extends Thread{
	public void run() {
		...
		String write_path = "/home/lsiem/logs/";
		String write_name = "ubuntu16-dmsg.log";
		String topic = "ubuntu16-dmsg";
		try{
			while(true){
				css.syslog(read_path,write_name,write_path,topic);
				Thread.sleep(10*1000);
...
class debug_thread extends Thread{
	public void run() {
		...
		String write_path = "/home/lsiem/logs/";
		String write_name = "ubuntu16-debug.log";
		String topic = "ubuntu16-debug";
		try{
			while(true){
				css.syslog(read_path,write_name,write_path,topic);
				Thread.sleep(10*1000);
...
class dpkg_thread extends Thread{
	public void run() {
		...
		String write_path = "/home/lsiem/logs/";
		String write_name = "ubuntu16-dpkg.log";
		String topic = "ubuntu16-dpkg.log";
		try{
			while(true){
				css.syslog(read_path,write_name,write_path,topic);
				Thread.sleep(10*1000);
